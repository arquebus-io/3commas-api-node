...
class threeCommasAPI {
  constructor (opts = {}) {
    this._url = opts.url || `${API_URL}/public/api`
  ...
  async getDealSafetyOrders (deal_id) {
    return await this.makeRequest('GET', `/ver1/deals/${deal_id}/market_orders?`, { deal_id })
  }

  async dealAddFunds (params) {
    return await this.makeRequest('POST', `/ver1/deals/${params.deal_id}/add_funds?`, params)
  }
  ...
  async smartTradesV2 (params) {
    return await this.makeRequest('GET', `/v2/smart_trades?`, params)
  }

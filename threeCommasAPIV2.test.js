...
const threeCommasAPIV2 = require('./threeCommasAPIV2');
...
describe('constructor must ', () => {
  test('take url as option', () => {
    ...
    const c = new threeCommasAPIV2(opts);
